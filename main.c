...
void GetComing()
{
    ...
    case 3:
    {
        coming[0][1].state = coming[1][1].state = coming[2][1].state =
            coming[3][1].state = MOVING;
        break;
    }  //|
    case 4:
    {
        coming[1][0].state = coming[1][1].state = coming[1][2].state =
            coming[2][1].state = MOVING;
        break;
    }  // T
    case 5:
    {
        coming[1][1].state = coming[2][1].state = coming[2][2].state =
            coming[3][2].state = MOVING;
        break;
    }  // S
    case 6:
    {
...
void DrawGame()
{
    ...
    DrawRectangle(SQUARE_SIZE * (GridX + 2), 0, SQUARE_SIZE, SQUARE_SIZE * 6,
                  GRAY);
    DrawRectangle(SQUARE_SIZE * (GridX + 2), 0, SQUARE_SIZE * 6, SQUARE_SIZE,
                  GRAY);
    DrawRectangle(SQUARE_SIZE * (GridX + 2), SQUARE_SIZE * 5, SQUARE_SIZE * 6,
                  SQUARE_SIZE, GRAY);
    DrawRectangle(SQUARE_SIZE * (GridX + 7), 0, SQUARE_SIZE, SQUARE_SIZE * 6,
                  GRAY);
